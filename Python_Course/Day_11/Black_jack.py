...
def calculate_score(cards):
    """Take a list of cards and return the score obtained from the cards"""
    # return sum(cards)
    sum_of_cards = 0
    for card in cards:
        sum_of_cards += card
...
def play_game():
    ...
    while not is_game_over:
        ...
        print(f"   Your's cards: {user_cards}, current score: {user_score}")
...
while input("Do you want to play again type 'y' if not type 'n' ") == 'y':
    os.system('cls')
    play_game()